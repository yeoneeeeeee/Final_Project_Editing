...
<title>YourFeed</title>
        ...
        <link rel="stylesheet" href="${contextPath}/WEB-INF/views/resources/css/MyFeed.css" />
        ...
        <link rel="stylesheet" type="text/css" href="${contextPath}/WEB-INF/views/resources/css/slick-theme.css" />
        <link rel="stylesheet" type="text/css" href="${contextPath}/WEB-INF/views/resources/css/slick.css" />
        <script type="text/javascript" src="${contextPath}/WEB-INF/views/resources/js/MyFeed.js"></script>
                           ...
                           <div class="user_Id">
                               <span>${otherUser.userNick}
                               		<c:if test="${otherUser.wbStatus == 'W'}">
                               			<img src="${contextPath}/WEB-INF/views/resources/images/goodIcon.jfif" />
                               		</c:if>
                               </span>
