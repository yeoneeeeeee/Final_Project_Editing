...
<title>Insert title here</title>
    ...
    <link rel="stylesheet" href="${contextPath}/WEB-INF/views/resources/css/EnrollForm.css">
</head>
<body>
     <div class="member">
         <!--  로고 -->
         ...
         <form id="enroll-form" action="${contextPath}/insert.me" method="post">
             ...
             <div class="chap1">
                 ...
                 <div class="btn-box">
                     ...
                     &nbsp;&nbsp;
                     <button type="button" class="btn btn-primary btn2 btn-lg" onclick="next();" id="next-btn" disabled>다음 단계</button>
                 </div>
             </div>
             <script>
                 function idCheck() {
             ...
             <div class="chap3">
                 ...
                 <div class="field">
                     ...
                     <input
                         ...
                         placeholder="인증 코드"
                     />
                     <button id="verification-submit-btn" class="btn btn-primary btn2 btn3" type="button" disabled>코드 확인</button>
                 </div>
                 <br /><br /><br /><br />
                 <!-- 가입하기 버튼 -->
                 <div class="btn-box">
                     <button type="button" class="btn btn-secondary btn2 btn-lg" onclick="tomain()">취소하기</button>
                     &nbsp;&nbsp;
                     <button type="submit" class="btn btn-primary btn2 btn-lg" id="enroll-btn" disabled>
                         가입하기
                     </button>
                 </div>
             </div>
     ...
     <script>
		...
		$.ajax({
		    ...
		    success: function (result) {
		        console.log(result);
		       $('#verification-submit-btn').removeAttr("disabled");
		       verificationCode = result;
		    }
		});
         });
         $("#verification-submit-btn").click(function(){
	         var code = $("#verification-code-input").val();
